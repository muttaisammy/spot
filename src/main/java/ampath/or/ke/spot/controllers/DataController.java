        ...
        if (session.getAttribute("company") != null && session.getAttribute("user") != null) {
            ...
            for (int s = 0; s < workbook.getNumberOfSheets(); s++) {
                ...
                for (int x = 1; x <= totalRowNum; x++) {
                    ...
                    //Corrected the indexes from Here

                    Cell prepnewsurgecell = dataRow.getCell(6);

                    if (prepnewsurgecell == null) {
                        prepnewsurge = 0.0;
                    } else {
                        prepnewsurge = dataRow.getCell(6).getNumericCellValue();
                    }

                    Cell newpbfwcell = dataRow.getCell(7);
                    ...
                    Cell opdworkloadcell = dataRow.getCell(8);

                    if (opdworkloadcell == null) {
                        opdworkload = 0.0;
                    } else {
                        opdworkload = dataRow.getCell(8).getNumericCellValue();
                    }

                    Cell noclientsscreenedcell = dataRow.getCell(9);

                    if (noclientsscreenedcell == null) {
                        noclientsscreened = 0.0;
                    } else {
                        noclientsscreened = dataRow.getCell(9).getNumericCellValue();
                    }

                    Cell identifiedsgbvcell = dataRow.getCell(10);

                    if (identifiedsgbvcell == null) {
                        identifiedsgbv = 0.0;
                    } else {
                        identifiedsgbv = dataRow.getCell(10).getNumericCellValue();
                    }

                    Cell identifiedphemcell = dataRow.getCell(11);

                    if (identifiedphemcell == null) {
                        identifiedphem = 0.0;
                    } else {
                        identifiedphem = dataRow.getCell(11).getNumericCellValue();
                    }

                    Cell bookedsurgecell = dataRow.getCell(12);

                    if (bookedsurgecell == null) {
                        bookedsurge = 0.0;
                    } else {
                        bookedsurge = dataRow.getCell(12).getNumericCellValue();
                    }

                    Cell honouredsurgecell = dataRow.getCell(13);

                    if (honouredsurgecell == null) {
                        honouredsurge = 0.0;
                    } else {
                        honouredsurge = dataRow.getCell(13).getNumericCellValue();
                    }

                    Cell scheduledvisitscell = dataRow.getCell(14);

                    if (scheduledvisitscell == null) {
                        scheduledvisits = 0.0;
                    } else {
                        scheduledvisits = dataRow.getCell(14).getNumericCellValue();
                    }

                    Cell keptappointmentcell = dataRow.getCell(15);

                    if (keptappointmentcell == null) {
                        keptappointment = 0.0;
                    } else {
                        keptappointment = dataRow.getCell(15).getNumericCellValue();
                    }

                    Cell cameearlycell = dataRow.getCell(16);

                    if (cameearlycell == null) {
                        cameearly = 0.0;
                    } else {
                        cameearly = dataRow.getCell(16).getNumericCellValue();
                    }

                    Cell missedappointmentcell = dataRow.getCell(17);

                    if (missedappointmentcell == null) {
                        missedappointment = 0.0;
                    } else {
                        missedappointment = dataRow.getCell(17).getNumericCellValue();
                    }

                    Cell bringbacksurgecell = dataRow.getCell(18);

                    if (bringbacksurgecell == null) {
                        bringbacksurge = 0.0;
                    } else {
                        bringbacksurge = dataRow.getCell(18).getNumericCellValue();
                    }

                    Cell broughtbacksurgecell = dataRow.getCell(19);

                    if (broughtbacksurgecell == null) {
                        broughtbacksurge = 0.0;
                    } else {
                        broughtbacksurge = dataRow.getCell(19).getNumericCellValue();
                    }

                    Cell targettobringbackcell = dataRow.getCell(20);

                    if (targettobringbackcell == null) {
                        targettobringback = 0.0;
                    } else {
                        targettobringback = dataRow.getCell(20).getNumericCellValue();
                    }

                    Cell numberbroughtbackcell = dataRow.getCell(21);

                    if (numberbroughtbackcell == null) {
                        numberbroughtback = 0.0;
                    } else {
                        numberbroughtback = dataRow.getCell(21).getNumericCellValue();
                    }

                    Cell viralloaddonecell = dataRow.getCell(22);

                    if (viralloaddonecell == null) {
                        viralloaddone = 0.0;
                    } else {
                        viralloaddone = dataRow.getCell(22).getNumericCellValue();
                    }

                    Cell newancvisitscell = dataRow.getCell(23);

                    if (newancvisitscell == null) {
                        newancvisits = 0.0;
                    } else {
                        newancvisits = dataRow.getCell(23).getNumericCellValue();
                    }

                    Cell kpsatanc1cell = dataRow.getCell(24);

                    if (kpsatanc1cell == null) {
                        kpsatanc1 = 0.0;
                    } else {
                        kpsatanc1 = dataRow.getCell(24).getNumericCellValue();
                    }

                    Cell testedatanc1cell = dataRow.getCell(25);

                    if (testedatanc1cell == null) {
                        testedatanc1 = 0.0;
                    } else {
                        testedatanc1 = dataRow.getCell(25).getNumericCellValue();
                    }

                    Cell syphilisatanc1hivposcell = dataRow.getCell(26);

                    if (syphilisatanc1hivposcell == null) {
                        syphilisatanc1hivpos = 0.0;
                    } else {
                        syphilisatanc1hivpos = dataRow.getCell(26).getNumericCellValue();
                    }

                    Cell syphilisat1stanccell = dataRow.getCell(27);

                    if (syphilisat1stanccell == null) {
                        syphilisat1stanc = 0.0;
                    } else {
                        syphilisat1stanc = dataRow.getCell(27).getNumericCellValue();
                    }

                    Cell eligibleforvltestcell = dataRow.getCell(28);

                    if (eligibleforvltestcell == null) {
                        eligibleforvltest = 0.0;
                    } else {
                        eligibleforvltest = dataRow.getCell(28).getNumericCellValue();
                    }

                    Cell vltestsdonecell = dataRow.getCell(29);

                    if (vltestsdonecell == null) {
                        vltestsdone = 0.0;
                    } else {
                        vltestsdone = dataRow.getCell(29).getNumericCellValue();
                    }

                    Cell initialtestslessthan8wkscell = dataRow.getCell(30);

                    if (initialtestslessthan8wkscell == null) {
                        initialtestslessthan8wks = 0.0;
                    } else {
                        initialtestslessthan8wks = dataRow.getCell(30).getNumericCellValue();
                    }

                    Cell initialtests8wksto12monthscell = dataRow.getCell(31);

                    if (initialtests8wksto12monthscell == null) {
                        initialtests8wksto12months = 0.0;
                    } else {
                        initialtests8wksto12months = dataRow.getCell(31).getNumericCellValue();
                    }

                    Cell totaleidcell = dataRow.getCell(32);

                    if (totaleidcell == null) {
                        totaleid = 0.0;
                    } else {
                        totaleid = dataRow.getCell(32).getNumericCellValue();
                    }

                    Cell eidposcell = dataRow.getCell(33);

                    if (eidposcell == null) {
                        eidpos = 0.0;
                    } else {
                        eidpos = dataRow.getCell(33).getNumericCellValue();
                    }

                    Cell bringbacktargetcell = dataRow.getCell(34);

                    if (bringbacktargetcell == null) {
                        bringbacktarget = 0.0;
                    } else {
                        bringbacktarget = dataRow.getCell(34).getNumericCellValue();
                    }

                    Cell broughtbackamongiitcell = dataRow.getCell(35);

                    if (broughtbackamongiitcell == null) {
                        broughtbackamongiit = 0.0;
                    } else {
                        broughtbackamongiit = dataRow.getCell(35).getNumericCellValue();
                    }

                    Cell determinestockathandcell = dataRow.getCell(36);

                    if (determinestockathandcell == null) {
                        determinestockathand = 0.0;
                    } else {
                        determinestockathand = dataRow.getCell(36).getNumericCellValue();
                    }

                    Cell responsestockathandcell = dataRow.getCell(37);

                    if (responsestockathandcell == null) {
                        responsestockathand = 0.0;
                    } else {
                        responsestockathand = dataRow.getCell(37).getNumericCellValue();
                    }

                    Cell duokitathandcell = dataRow.getCell(38);

                    if (duokitathandcell == null) {
                        duokitathand = 0.0;
                    } else {
                        duokitathand = dataRow.getCell(38).getNumericCellValue();
                    }

                    Cell dbsfilterpaperscell = dataRow.getCell(39);

                    if (dbsfilterpaperscell == null) {
                        dbsfilterpapers = 0.0;
                    } else {
                        dbsfilterpapers = dataRow.getCell(39).getNumericCellValue();
                    }

                    Cell cxcascreenedcell = dataRow.getCell(40);

                    if (cxcascreenedcell == null) {
                        cxcascreened = 0.0;
                    } else {
                        cxcascreened = dataRow.getCell(40).getNumericCellValue();
                    }

                    Cell cxcascreenedposcell = dataRow.getCell(41);

                    if (cxcascreenedposcell == null) {
                        cxcascreenedpos = 0.0;
                    } else {
                        cxcascreenedpos = dataRow.getCell(41).getNumericCellValue();
                    }

                    Cell cxcareceivedtreatmentcell = dataRow.getCell(42);

                    if (cxcareceivedtreatmentcell == null) {
                        cxcareceivedtreatment = 0.0;
                    } else {
                        cxcareceivedtreatment = dataRow.getCell(42).getNumericCellValue();
                    }

                    Cell cxcasuspectedcell = dataRow.getCell(43);

                    if (cxcasuspectedcell == null) {
                        cxcasuspected = 0.0;
                    } else {
                        cxcasuspected = dataRow.getCell(43).getNumericCellValue();
                    }

                    Cell currneverontptcell = dataRow.getCell(44);

                    if (currneverontptcell == null) {
                        currneverontpt = 0.0;
                    } else {
                        currneverontpt = dataRow.getCell(44).getNumericCellValue();
                    }

                    Cell screenednegfortbcell = dataRow.getCell(45);

                    if (screenednegfortbcell == null) {
                        screenednegfortb = 0.0;
                    } else {
                        screenednegfortb = dataRow.getCell(45).getNumericCellValue();
                    }

                    Cell startedtpttxnewcell = dataRow.getCell(46);

                    if (startedtpttxnewcell == null) {
                        startedtpttxnew = 0.0;
                    } else {
                        startedtpttxnew = dataRow.getCell(46).getNumericCellValue();
                    }

                    Cell startedtpttxcurrcell = dataRow.getCell(47);

                    if (startedtpttxcurrcell == null) {
                        startedtpttxcurr = 0.0;
                    } else {
                        startedtpttxcurr = dataRow.getCell(47).getNumericCellValue();
                    }

                    Cell startedtptcell = dataRow.getCell(48);

                    if (startedtptcell == null) {
                        startedtpt = 0.0;
                    } else {
                        startedtpt = dataRow.getCell(48).getNumericCellValue();
                    }

                    Cell daily1st95childrentestedcell = dataRow.getCell(49);

                    if (daily1st95childrentestedcell == null) {
                        daily1st95childrentested = 0.0;
                    } else {
                        daily1st95childrentested = dataRow.getCell(49).getNumericCellValue();
                    }

                    Cell daily2ndand3rd95cacxtargetedwracell = dataRow.getCell(50);

                    if (daily2ndand3rd95cacxtargetedwracell == null) {
                        daily2ndand3rd95cacxtargetedwra = 0.0;
                    } else {
                        daily2ndand3rd95cacxtargetedwra = dataRow.getCell(50).getNumericCellValue();
                    }

                    Cell daily2ndand3rd95eligibleforvltestcell = dataRow.getCell(51);

                    if (daily2ndand3rd95eligibleforvltestcell == null) {
                        daily2ndand3rd95eligibleforvltest = 0.0;
                    } else {
                        daily2ndand3rd95eligibleforvltest = dataRow.getCell(51).getNumericCellValue();
                    }

                    Cell daily2ndand3rd95hpv10to14yrseligiblecell = dataRow.getCell(52);

                    if (daily2ndand3rd95hpv10to14yrseligiblecell == null) {
                        daily2ndand3rd95hpv10to14yrseligible = 0.0;
                    } else {
                        daily2ndand3rd95hpv10to14yrseligible = dataRow.getCell(52).getNumericCellValue();
                    }

                    Cell daily2ndand3rd95hpv10to14yrs95vaccinatedcell = dataRow.getCell(53);

                    if (daily2ndand3rd95hpv10to14yrs95vaccinatedcell == null) {
                        daily2ndand3rd95hpv10to14yrs95vaccinated = 0.0;
                    } else {
                        daily2ndand3rd95hpv10to14yrs95vaccinated = dataRow.getCell(53).getNumericCellValue();
                    }

                    Cell daily2ndand3rd95newlyiitcell = dataRow.getCell(54);

                    if (daily2ndand3rd95newlyiitcell == null) {
                        daily2ndand3rd95newlyiit = 0.0;
                    } else {
                        daily2ndand3rd95newlyiit = dataRow.getCell(54).getNumericCellValue();
                    }

                    Cell daily2ndand3rd95tbcccscreenedcell = dataRow.getCell(55);

                    if (daily2ndand3rd95tbcccscreenedcell == null) {
                        daily2ndand3rd95tbcccscreened = 0.0;
                    } else {
                        daily2ndand3rd95tbcccscreened = dataRow.getCell(55).getNumericCellValue();
                    }

                    Cell daily2ndand3rd95tbcccworkloadcell = dataRow.getCell(56);

                    if (daily2ndand3rd95tbcccworkloadcell == null) {
                        daily2ndand3rd95tbcccworkload = 0.0;
                    } else {
                        daily2ndand3rd95tbcccworkload = dataRow.getCell(56).getNumericCellValue();
                    }

                    Cell daily2ndand3rd95tbopdscreenedcell = dataRow.getCell(57);

                    if (daily2ndand3rd95tbopdscreenedcell == null) {
                        daily2ndand3rd95tbopdscreened = 0.0;
                    } else {
                        daily2ndand3rd95tbopdscreened = dataRow.getCell(57).getNumericCellValue();
                    }

                    Cell daily2ndand3rd95tbopdworkloadcell = dataRow.getCell(58);

                    if (daily2ndand3rd95tbopdworkloadcell == null) {
                        daily2ndand3rd95tbopdworkload = 0.0;
                    } else {
                        daily2ndand3rd95tbopdworkload = dataRow.getCell(58).getNumericCellValue();
                    }

                    Cell otherhivtestscell = dataRow.getCell(59);

                    if (otherhivtestscell == null) {
                        otherhivtests = 0.0;
                    } else {
                        otherhivtests = dataRow.getCell(59).getNumericCellValue();
                    }

                    Cell knownstatuskpplustestedcell = dataRow.getCell(60);

                    if (knownstatuskpplustestedcell == null) {
                        knownstatuskpplustested = 0.0;
                    } else {
                        knownstatuskpplustested = dataRow.getCell(60).getNumericCellValue();
                    }

                    Cell pmtctstattdcell = dataRow.getCell(61);

                    if (pmtctstattdcell == null) {
                        pmtctstattd = 0.0;
                    } else {
                        pmtctstattd = dataRow.getCell(61).getNumericCellValue();
                    }

                    Cell tptcummulativecell = dataRow.getCell(62);

                    if (tptcummulativecell == null) {
                        tptcummulative = 0.0;
                    } else {
                        tptcummulative = dataRow.getCell(62).getNumericCellValue();
                    }

                    Cell completedtptcell = dataRow.getCell(63);

                    if (completedtptcell == null) {
                        completedtpt = 0.0;
                    } else {
                        completedtpt = dataRow.getCell(63).getNumericCellValue();
                    }

                    Cell completedtpttxnewcell = dataRow.getCell(64);

                    if (completedtpttxnewcell == null) {
                        completedtpttxnew = 0.0;
                    } else {
                        completedtpttxnew = dataRow.getCell(64).getNumericCellValue();
                    }

                    Cell completedtpttxcurrcell = dataRow.getCell(65);

                    if (completedtpttxcurrcell == null) {
                        completedtpttxcurr = 0.0;
                    } else {
                        completedtpttxcurr = dataRow.getCell(65).getNumericCellValue();
                    }

                    Cell missedhivtestingtargetcell = dataRow.getCell(66);

                    if (missedhivtestingtargetcell == null) {
                        missedhivtestingtarget = 0.0;
                    } else {
                        missedhivtestingtarget = dataRow.getCell(66).getNumericCellValue();
                    }

                    Cell reachedandaccountedcell = dataRow.getCell(67);

                    if (reachedandaccountedcell == null) {
                        reachedandaccounted = 0.0;
                    } else {
                        reachedandaccounted = dataRow.getCell(67).getNumericCellValue();
                    }

                    Cell newiitclientscell = dataRow.getCell(68);

                    if (newiitclientscell == null) {
                        newiitclients = 0.0;
                    } else {
                        newiitclients = dataRow.getCell(68).getNumericCellValue();
                    }
                    ...
                    if (tptuptakeeligiblefortptcell == null) {
                        ...
                        tptuptakeeligiblefortpt = dataRow.getCell(69).getNumericCellValue();
                    }

                    Cell tptuptakestartedontptcell = dataRow.getCell(70);

                    if (tptuptakestartedontptcell == null) {
                        tptuptakestartedontpt = 0.0;
                    } else {
                        tptuptakestartedontpt = dataRow.getCell(70).getNumericCellValue();
                    }

                    Cell prepnewagywcell = dataRow.getCell(71);

                    if (prepnewagywcell == null) {
                        prepnewagyw = 0.0;
                    } else {
                        prepnewagyw = dataRow.getCell(71).getNumericCellValue();
                    }

                    Cell weekcell = dataRow.getCell(72);

                    if (weekcell == null) {
                        week = "0.0";
                    } else {
                        // week = dataRow.getCell(72).getNumericCellValue();
                    }

                    Cell monthcell = dataRow.getCell(73);

                    if (monthcell == null) {
                        month = "0.0";
                    } else {
                        //month = dataRow.getCell(73).getNumericCellValue();
                    }
