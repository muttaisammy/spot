(function (global, factory) {
    ...
    const basicEchartsInit = () => {
        ...
        document.querySelectorAll("[data-echarts]").forEach((r) => {
            ...
            echartSetOption(i, e, () => ({
                color: t("primary"),
                tooltip: { trigger: "item", padding: [7, 10], backgroundColor: t("gray-100"), borderColor: t("gray-300"), textStyle: { color: t("dark") }, borderWidth: 1, transitionDuration: 0 },
                xAxis: {
                    type: "category",
                    ...
                    axisTick: { show: !1 },
                    axisLabel: { formatter: (t) => window.dayjs(t).format("DD MMM"), interval: 6, showMinLabel: !0, showMaxLabel: !0, color: t("gray-800") },
                },
    ...
    const reportsDetailsChartInit = () => {
        ...
        if (o) {
            ...
            echartSetOption(l, n, () => ({
                ...
                tooltip: { trigger: "axis", padding: [7, 10], backgroundColor: t("gray-100"), borderColor: t("gray-300"), textStyle: { color: t("dark") }, borderWidth: 1, transitionDuration: 0, axisPointer: { type: "none" }, formatter: r },
                xAxis: {
                    type: "category",
                    data: ["Analysis", "Statement", "Action", "Offering", "Interlocution"],
                    axisLabel: { color: t("gray-900"), fontFamily: "Nunito Sans", fontWeight: 600, fontSize: 12.8, rotate: 30, formatter: (t) => `${t.slice(0, 5)}...` },
                    axisLine: { lineStyle: { color: t("gray-200") } },
                    axisTick: !1,
                },
                yAxis: { type: "value", splitLine: { lineStyle: { color: t("gray-200") } }, axisLabel: { color: t("gray-900"), fontFamily: "Nunito Sans", fontWeight: 700, fontSize: 12.8, margin: 24, formatter: (t) => `${t}%` } },
                series: [
                    {
                        name: "Revenue",
                        type: "bar",
        ...
        initialDomSetup = (e) => {
            ...
            e &&
                e.querySelectorAll("[data-theme-control]").forEach((e) => {
                    ...
                    if (("phoenixNavbarVerticalStyle" === a && ("horizontal" === n || "dual-nav" === n) && e.setAttribute("disabled", !0), "checkbox" === e.type))
            ...
            initialDomSetup(a.node),
                a.on("click", (e) => {
                    ...
                    if (c.data("theme-control")) {
                        ...
                        switch (
                            ("phoenixTheme" === l && "boolean" == typeof d && (d = d ? "dark" : "light"), config.hasOwnProperty(l) && window.config.set({ [l]: d }), window.history.replaceState(null, null, window.location.pathname), l)
                        ) {
                            case "phoenixTheme": {
                                document.documentElement.classList["dark" === d ? "add" : "remove"]("dark");
                                const t = new CustomEvent("clickControl", { detail: { control: l, value: d } });
                            ...
                            case "phoenixNavbarPosition":
                                ...
                                break;
                            case "phoenixIsRTL":
                                window.config.set({ phoenixIsRTL: c.node.checked }), window.location.reload();
                                break;
